...
import com.example.gateway.global.error.exception.token.TokenExpiredException;
...
public class ExceptionController {
    ...
    public Mono<ResponseEntity<ErrorMsg>> tokenValidExceptionHandler(TokenValidException e) {
        ...
        return Mono.just(ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ErrorMsg(e.getMessage())));
    }
